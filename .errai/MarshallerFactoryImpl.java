...
@Dependent public class MarshallerFactoryImpl implements MarshallerFactory {
      ...
      public RESTLanguageImageV1 demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          if ((obj.containsKey("imageData")) && (!obj.get("imageData").isNull())) {
            com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_imageData(entity, arrayOf_byte_D1.demarshall(obj.get("imageData"), a1));
          }
          if ((obj.containsKey("thumbnail")) && (!obj.get("thumbnail").isNull())) {
            com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_thumbnail(entity, arrayOf_byte_D1.demarshall(obj.get("thumbnail"), a1));
          }
          if ((obj.containsKey("imageDataBase64")) && (!obj.get("imageDataBase64").isNull())) {
            com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_imageDataBase64(entity, arrayOf_byte_D1.demarshall(obj.get("imageDataBase64"), a1));
          }
  ...
  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_imageData(RESTLanguageImageV1 instance, byte[] value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTLanguageImageV1::imageData = value;
  }-*/;

  private native static byte[] com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_imageData(RESTLanguageImageV1 instance) /*-{
    return instance.@com.redhat.topicindex.rest.entities.interfaces.RESTLanguageImageV1::imageData;
  }-*/;

  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_thumbnail(RESTLanguageImageV1 instance, byte[] value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTLanguageImageV1::thumbnail = value;
  }-*/;

  private native static byte[] com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_thumbnail(RESTLanguageImageV1 instance) /*-{
    return instance.@com.redhat.topicindex.rest.entities.interfaces.RESTLanguageImageV1::thumbnail;
  }-*/;

  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_imageDataBase64(RESTLanguageImageV1 instance, byte[] value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTLanguageImageV1::imageDataBase64 = value;
  }-*/;

  private native static byte[] com_redhat_topicindex_rest_entities_interfaces_RESTLanguageImageV1_imageDataBase64(RESTLanguageImageV1 instance) /*-{
    return instance.@com.redhat.topicindex.rest.entities.interfaces.RESTLanguageImageV1::imageDataBase64;
  }-*/;

  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTTranslatedTopicV1_translatedTopicStrings(RESTTranslatedTopicV1 instance, RESTTranslatedTopicStringCollectionV1 value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTTranslatedTopicV1::translatedTopicStrings = value;
  }-*/;

  private native static RESTTranslatedTopicStringCollectionV1 com_redhat_topicindex_rest_entities_interfaces_RESTTranslatedTopicV1_translatedTopicStrings(RESTTranslatedTopicV1 instance) /*-{
