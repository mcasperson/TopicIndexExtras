...
public class MarshallerFactoryImpl implements MarshallerFactory {
  ...
  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTTranslatedTopicV1_translatedTopicStrings(RESTTranslatedTopicV1 instance, BaseRestCollectionV1 value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTTranslatedTopicV1::translatedTopicStrings = value;
  }-*/;

  private native static BaseRestCollectionV1 com_redhat_topicindex_rest_entities_interfaces_RESTTranslatedTopicV1_translatedTopicStrings(RESTTranslatedTopicV1 instance) /*-{
    return instance.@com.redhat.topicindex.rest.entities.interfaces.RESTTranslatedTopicV1::translatedTopicStrings;
  }-*/;

  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTImageV1_imageData(RESTImageV1 instance, byte[] value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTImageV1::imageData = value;
  }-*/;

  private native static byte[] com_redhat_topicindex_rest_entities_interfaces_RESTImageV1_imageData(RESTImageV1 instance) /*-{
    return instance.@com.redhat.topicindex.rest.entities.interfaces.RESTImageV1::imageData;
  }-*/;

  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTImageV1_thumbnail(RESTImageV1 instance, byte[] value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTImageV1::thumbnail = value;
  }-*/;

  private native static byte[] com_redhat_topicindex_rest_entities_interfaces_RESTImageV1_thumbnail(RESTImageV1 instance) /*-{
    return instance.@com.redhat.topicindex.rest.entities.interfaces.RESTImageV1::thumbnail;
  }-*/;

  private native static void com_redhat_topicindex_rest_entities_interfaces_RESTImageV1_imageDataBase64(RESTImageV1 instance, byte[] value) /*-{
    instance.@com.redhat.topicindex.rest.entities.interfaces.RESTImageV1::imageDataBase64 = value;
  }-*/;

  private native static byte[] com_redhat_topicindex_rest_entities_interfaces_RESTImageV1_imageDataBase64(RESTImageV1 instance) /*-{
    return instance.@com.redhat.topicindex.rest.entities.interfaces.RESTImageV1::imageDataBase64;
  }-*/;
